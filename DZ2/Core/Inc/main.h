...
#define SEG7_A_Pin GPIO_PIN_1
#define SEG7_A_GPIO_Port GPIOC
#define SEG7_B_Pin GPIO_PIN_2
#define SEG7_B_GPIO_Port GPIOC
#define SEG7_C_Pin GPIO_PIN_3
#define SEG7_C_GPIO_Port GPIOC
